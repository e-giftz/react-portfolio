                ...
                <div className="right">
                    <div className="profile-text">
                        ...
                        <p>I am an enthusiastic and dedicated Full Stack Web developer with a number of successful projects bagged.
                            I have background in both manual testing and software test automation frameworks with a degree in Computing.</p>
                        <br />
                        <p>However, I recently graduated from the Full Stack Web developer bootcamp and have gained extensive knowledge of
                            front-end and back-end web development with a number of creative projects worked on. 
                            These applications in addition are intuitive and responsive user interactive applications.</p>
                        <br />
